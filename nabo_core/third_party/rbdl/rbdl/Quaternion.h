...
class Quaternion : public Vector4d {
  ...
  {}
    ...
    static Quaternion fromMatrix (const Matrix3d &mat) {
      float tr = float(mat(0,0) + mat(1,1) + mat(2,2));
      if (tr > 0) {
        float w = float(std::sqrt(1.f + tr) * 0.5);
        return Quaternion (
            (mat(1,2) - mat(2,1)) / (w * 4.),
            (mat(2,0) - mat(0,2)) / (w * 4.),
            (mat(0,1) - mat(1,0)) / (w * 4.),
        ...
        float x = float(std::sqrt(1.0 + mat(0,0) - mat(1,1) - mat(2,2)) * 0.5);
        return Quaternion(
            x,
            (mat(1,0) + mat(0,1)) / (x * 4.),
            (mat(2,0) + mat(0,2)) / (x * 4.),
        ...
        float y = float(std::sqrt(1.0 + mat(1,1) - mat(0,0) - mat(2,2)) * 0.5);
        return Quaternion(
            (mat(1,0) + mat(0,1)) / (y * 4.),
            y,
            (mat(2,1) + mat(1,2)) / (y * 4.),
        ...
        float z = float(std::sqrt(1.0 + mat(2,2) - mat(0,0) - mat(1,1)) * 0.5);
        return Quaternion(
            (mat(2,0) + mat(0,2)) / (z * 4.),
            (mat(2,1) + mat(1,2)) / (z * 4.),
            z,
